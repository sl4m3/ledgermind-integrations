...
from ledgermind_integrations.protocol import (
    RawRoundValidationError,
    calculate_payload_digest,
    validate_raw_round,
)

_FIXTURE = Path(__file__).resolve().parents[2] / "conformance" / "fixtures" / "hermes_complete.json"


def test_fixture_has_the_same_digest_as_core_contract() -> None:
